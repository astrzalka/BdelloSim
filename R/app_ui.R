...
app_ui <- fluidPage(
  ...
  fluidRow(
    column(2,
           ...
           br(),
           textInput('host_name_1', 'Host name', value = 'Salmonella enterica'),
           sliderInput('host_start_1', 'Input starting number of host cells [mln]', value = 0.45, min = 0, max = 10, step = 0.05),
           sliderInput('bdello_start_1', 'Input starting number of Bdellivibrio cells', value = 1000, min = 1, max = 1000, step = 1),
    ...
    column(2,
           ...
           conditionalPanel("input.host_2",
                            ...
                            sliderInput('host_start_2', 'Input starting number of host cells [mln]', value = 0.7, min = 0, max = 10, step = 0.05),
                            sliderInput('bdello_start_2', 'Input starting number of Bdellivibrio cells', value = 1000, min = 1, max = 1000, step = 1),
    ...
    column(2,
           ...
           conditionalPanel("input.host_3",
                            ...
                            sliderInput('host_start_3', 'Input starting number of host cells [mln]', value = 0.15, min = 0, max = 10, step = 0.05),
                            sliderInput('bdello_start_3', 'Input starting number of Bdellivibrio cells', value = 1000, min = 1, max = 1000, step = 1),
