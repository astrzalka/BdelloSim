...
app_ui <- fluidPage(
  ...
  fluidRow(
    column(2,
           ...
           sliderInput('host_start_1', 'Input starting number of host cells [mln]', value = 0.5, min = 0, max = 10, step = 0.05),
    ...
    column(2,
           ...
           conditionalPanel("input.host_2",
                            ...
                            sliderInput('host_start_2', 'Input starting number of host cells [mln]', value = 0.5, min = 0, max = 10, step = 0.05),
    ...
    column(2,
           ...
           conditionalPanel("input.host_3",
                            ...
                            sliderInput('host_start_3', 'Input starting number of host cells [mln]', value = 0.5, min = 0, max = 10, step = 0.05),
