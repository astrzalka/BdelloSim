...
app_ui <- fluidPage(
  ...
  fluidRow(
    column(2,
           ...
           sliderInput('host_start_1', 'Input starting number of host cells', value = 500000, min = 100, max = 10000000, step = 100),
    ...
    column(2,
           ...
           conditionalPanel("input.host_2",
                            ...
                            sliderInput('host_start_2', 'Input starting number of host cells', value = 500000, min = 100, max = 10000000, step = 100),
    ...
    column(2,
           ...
           conditionalPanel("input.host_3",
                            ...
                            sliderInput('host_start_3', 'Input starting number of host cells', value = 500000, min = 100, max = 10000000, step = 100),
